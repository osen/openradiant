...
CSynapseClient* SYNAPSE_DLL_EXPORT mapxml_EnumerateInterfaces(const char* version, CSynapseServer* pServer) {
	return mapxml::EnumerateInterfaces(version, pServer);
}